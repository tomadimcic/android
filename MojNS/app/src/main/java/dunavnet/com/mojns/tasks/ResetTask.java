...
public class ResetTask extends AsyncTask<Void, Void, String> {
    ...
    private static final String CATEGORY_PATH = "ResetPassword";
    ...
    private String mEmail, mPassword, mConfirmed, mCode;

    public ResetTask(Context context, String email, String password, String cofirmed, String code){
        mContext = context;
