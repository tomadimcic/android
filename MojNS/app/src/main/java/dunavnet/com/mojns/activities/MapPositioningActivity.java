...
import dunavnet.com.mojns.tasks.ReportTask;
...
public class MapPositioningActivity extends FragmentActivity implements OnMapReadyCallback, LocationListener, GoogleMap.OnMarkerDragListener, ResponseHandler {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        icon = this.getResources().getDrawable(R.drawable.pin1);
        //setUpMapIfNeeded();
    ...
    public void sendLogData(String id){
        ...
        LogData log = LogData.createLog(4, message, "CommunityPoliceSubmitIssueMojNS()", "NOMp02", Util.getipv4Address(this), "NOMs08");
