...
public class SwitchControl extends PiControl implements SingleOptionControl {

	private static final long serialVersionUID = 5745351793518786268L;

	public static final String URL_SWITCH_CONTROL = "/switch";
	public static final int ICON = R.drawable.ic_taster;
	int icon;

	protected boolean isTurnedOn;

	public SwitchControl() {
		piControlType = PiControlType.SWITCH;
		name = new String();
	}
	...
	public String toJsonForSending() {
		...
		try {
			switchJson.put(ID, id);
			switchJson.put(VALUE, isTurnedOn);
		} catch (JSONException e) {
			return null;
		}
		return switchJson.toString();
	}
