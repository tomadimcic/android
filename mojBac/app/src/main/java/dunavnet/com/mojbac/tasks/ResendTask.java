 ...
 */
public class ResendTask extends AsyncTask<Void, Void, String> {

    private static final String URL = "http://idm-dnet.dunavnet.eu/webapi/api/Account/";
    private static final String CATEGORY_PATH = "ResendConfirmationEmail";
    ...
    public ResendTask(Context context, String email){
        mContext = context;
