...
public class LoadCategories extends AsyncTask<Void, Void, String> {
    ...
    private static final String CATEGORY_PATH = "CommunityPoliceOdzaciRetriveIssueCategory";
    ...
    public LoadCategories(Context context, int id){
        mContext = context;
    ...
    protected String doInBackground(Void... args) {
        ...
        try {
                ...
                HttpGet request = new HttpGet(URL + CATEGORY_PATH + "?TopicId=" + mId);
