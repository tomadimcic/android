...
public class VerifyCodeTask extends AsyncTask<Void, Void, String> {
    ...
    private static final String CATEGORY_PATH = "ConfirmEmailByCode";
    ...
    private String mEmail, mCode;

    public VerifyCodeTask(Context context, String email, String code){
        mContext = context;
    ...
    protected void onPreExecute() {
        progressDialog = ProgressDialog.show(mContext, null, mContext.getResources().getString(R.string.contacting_server), true, true, new DialogInterface.OnCancelListener() {
            ...
            public void onCancel(DialogInterface dialog) {
                VerifyCodeTask.this.cancel(true);
            }
